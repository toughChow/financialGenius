	...
	<div class="main">
		...
		<div class="left">
			<li id="li5"><a href="admin_view_main"><i class="fa fa fa-envira fa-fw"></i></a>&nbsp;HOME</li>
 			<li id="li1"><a href=""><i class="fa fa fa-user fa fa-fw"></i></a>&nbsp;user manage</li>
				...
				<li class="li1-li"><a href="admin_view_manageUser" id="a"><i class="fa fa-angle-right fa-fw"></i>&nbsp;&nbsp;&nbsp;&nbsp;删除用户</a></li>
		...
		<div class="right">
			...
			<div class="head-bottom">
				<div class="query">
					<div class="head-left">
						<a href=""><i class="fa fa-list"></i></a>&nbsp;&nbsp;HOME
					</div>
				</div>
				<br>
				<br>
				<img src="admin/images/1.PNG" style="display: block;margin-left: 380px;">
				<img src="admin/images/3.PNG" style="margin-left: 90px;">
				<img src="admin/images/2.PNG" id="img1" style="margin-left: 50px;">
