	...
	<div class="main">
		...
		<div class="right">
			...
			<div class="head-bottom">
				...
				<br>
				<br>
				<img src="images/1.PNG" style="display: block;margin-left: 380px;">
				<img src="images/3.PNG" style="margin-left: 90px;">
				<img src="images/2.PNG" id="img1" style="margin-left: 50px;">
