	...
	<div class="main">
		<div class="head">
			...
			<div class="head2">
				...
				<a href="">设置</a>&nbsp;&nbsp;<a href="">帮助</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
					...
					<option value="admin_view_changePassword?admin.id=${id }">修改密码</option>
		...
		<div class="right">
			...
			<div class="head-bottom">
				...
				<br> <br> <img src="admin/images/1.PNG"
					style="display: block; margin-left: 380px;"> <img
					src="admin/images/3.PNG" style="margin-left: 90px;"> <img
					src="admin/images/2.PNG" id="img1" style="margin-left: 50px;">
